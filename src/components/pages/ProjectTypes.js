...
const WhoAreWe = () => (
  <Section className="bg-light pb-4 container-fluid">
    ...
    <SectionRow>
      ...
      >
        ...
        <p className="lead">
          ...
          fabricando e instalando esquadrias de alumínio conforme a necessidade
          do projeto.
        </p>
      </Col>
      <Col
    ...
    <SectionRow className="mb-5">
      ...
      >
        ...
        <p className="lead">
          Além de trabalhar com as esquadrias tradicionais, somos especialistas
          na fabricação e instalação de fachadas, tais como glazing, cortina e
          brises.
        </p>
      </Col>
    </SectionRow>
    <SectionRow>
      ...
      >
        ...
        <p className="lead">
          Trabalhamos com uma ampla variedade de portas, portões e janelas, além
          de sermos especialistas na fabricação e instalação de fachadas, tais
          como glazing, cortina e brises.
        </p>
      </Col>
      <Col
        md={{ span: 6, offset: 1 }}
    ...
    <SectionRow className="mb-5">
      ...
      >
        ...
        <p className="lead">
          Atendemos os mais diversos projetos de clubes e academias, realizando
          desde o fechamento de fachadas até a fabricação e instalação de
